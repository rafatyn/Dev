...
BYTE send_cmd(BYTE *);
BYTE SD_read_lba(UINT16 *,UINT32);
BYTE SD_card_init(void);
void SD_Start_Multi_Read(UINT32);
void SD_Stop();
...
const BYTE cmd18[5]  = {0x52,0x00,0x00,0x00,0x00}; //Multi read
const BYTE cmd12[5]  = {0x4c,0x00,0x00,0x00,0x00}; //stop
