...
<html lang="es">
    ...
    <body onload="cambiarp(0,1,0,'','','','')">
        <div id="ci" style="display: none">PS4500GBGTAV/</div>
        <div class="cuerpo" onclick="oc('droplist')">
            <div class="cu_cabecera">
                <div class="nombre">
                    <h1>PS4 500GB + GTA V</h1>
                </div>
                <div class="imagen">
                    <div class="ip">
                        <div class="img" style="background-image: url('img/PS4500GBGTAV/foto1-1.jpg')"><button class="bt" onclick="cambiarp(0,1,0,'','','','')"></button></div>
                        <div class="img" style="background-image: url('img/PS4500GBGTAV/foto2-1.jpg')"><button class="bt" onclick="cambiarp(0,2,0,'','','','')"></button></div>
                        <div class="img" style="background-image: url('img/PS4500GBGTAV/foto3-1.jpg')"><button class="bt" onclick="cambiarp(0,3,0,'','','','')"></button></div>
                        <div class="img" style="background-image: url('img/PS4500GBGTAV/foto4-1.jpg')"><button class="bt" onclick="cambiarp(0,4,2,'black','white','','')"></button></div>
                    </div>
                    <div class="ig">
                ...
                <div class="precio">
                    ...
                    <div class="comprar">
                        <form method="post" action="../cart.php?id=9">
...
Y además incluye el GTA V, para que puedas disfrutar de Los Santos, una extensa y soleada metrópolis llena de gurús de autoayuda, aspirantes a estrellas y famosos en decadencia, en su día la envidia del mundo occidental, lucha ahora por mantenerse a flote en una era de incertidumbre económica y "realities" baratos. En medio de la confusión, tres criminales muy diferentes lo arriesgarán todo en una serie de atrevidos y peligrosos atracos que marcarán sus vidas. <br><br>
El mundo abierto más grande, más dinámico y más diverso jamás creado, ahora con un montón de detalles nuevos. Grand Theft Auto V combina historia y jugabilidad de una nueva forma. Los jugadores entran y salen repetidamente de las vidas de los tres personajes principales, participando en todos los aspectos de la historia entrelazada del juego. <br><br></p>
                </div>
                <div class="cu_opi cu_in">
                    <div class="opi opiult">
                        ...
                        <div class="tex">
                            <p>Es la mejor consola de esta generación y la mejor de todo el mercado, junto con el mejor juego de los ultimos años, para mi compra 100% asegurada.</p>
                            <div class="reco">
