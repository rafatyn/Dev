...
QT_MOC_LITERAL(1, 15, 10), // "Terminated"
QT_MOC_LITERAL(2, 26, 0) // ""

    },
    "ProgressWindow\0Terminated\0"
};
...
void ProgressWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ProgressWindow::Terminated)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject ProgressWindow::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_ProgressWindow.data,
...
// SIGNAL 0
void ProgressWindow::Terminated()
{
