...
/**	
	...
	\details 	Metodo que devuelve el estado siguiente dependiendo de la entrada.
	
	      * @param x la entrada que hace transitar de un estado al siguiente
...
/**	
	...
	\details 	Metodo que comprueba si un estado es igual que el otro.
	
	      * @param  x estado que se quiere comprobar.
	      * @return valor de la comprobacion.
	      * @retval TRUE los estados son iguales.
	      * @retval FALSE los estados son diferentes.
