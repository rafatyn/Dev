...
/**	
	...
	\details 	Metodo que devuelve la transicion del estado con el caracter que se le pasa.
	
	      * @return la transicion para el caracter.
	      * @param x caracter de entrada de la transicion.

*/

    transicion get_transicion(char x) const;

/**	
        \author 	Rafael González de Chaves González (alu0100891812@ull.edu.es)
        \date 		16 de octubre de 2015

	\details 	Metodo que devuelde el estado siguiente para el caracter que se pasa por parametros.
...
/**	
	...
	\details 	Metodo que comprueba si dos estados son iguales.
	      ...
	      * @param  x estado con el que se quiere comparar.
